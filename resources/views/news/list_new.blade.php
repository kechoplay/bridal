                                                    ...
                                                    <a href="{{ route('shop.productDetails', ['nameProduct' => $dr->slug]) }}" class="grid-product__link">
                                                        ...
                                                        <div class="grid-product__meta">
                                                            ...
                                                            <div class="grid-product__price"><span class="visually-hidden" data-open-accessibility-text-original="13.6px" style="font-size: 13.6px;">Regular price</span>
                                                                @if($dr->sale_price != 0)
                                                                    <span class="grid-product__price--original" data-open-accessibility-text-original="13.6px" style="font-size: 13.6px;">{{ __(':price$', ['price' => @number_format($dr->price)]) }}</span>
                                                                    <span class="visually-hidden" data-open-accessibility-text-original="13.6px" style="font-size: 13.6px;"></span>{{ __(':price$', ['price' => @number_format($dr->sale_price)]) }}
