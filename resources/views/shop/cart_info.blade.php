...
<head>
    ...
    <title>    Information - THEIA - Checkout</title>
    ...
    <meta id="autocomplete-service-sandbox-url" name="autocomplete-service-sandbox-url" content="https://checkout.shopify.com/5466033/sandbox/autocomplete_service?locale=en" />
    <meta property="og:title" content="Purchase Allison Dress and 1 other item" />
    <meta property="og:image" content="https://cdn.shopify.com/s/files/1/0546/6033/products/8814495_2518_1_1024x1024.jpg?v=1621350913" />

    <!--[if lt IE 9]>
    <link rel="stylesheet" media="all" href="//cdn.shopify.com/app/services/5466033/assets/122321436860/checkout_stylesheet/v2-ltr-edge-1861300a509749f47020b0e786604d3f-2145/oldie" />
    <![endif]-->
    ...
    <script src="//cdn.shopify.com/app/services/5466033/javascripts/checkout_countries/122321436860/en/countries-9c784bd4d5aff3490e87892904bd4d06cddc0ccb-9c784bd4d5aff3490e87892904bd4d06cddc0ccb-1619810820-e1413a830127c0c2806dff1ce9313204d837ef12.js?version=edge" crossorigin="anonymous"></script>
    ...
    <script src="//cdn.shopify.com/shopifycloud/shopify/assets/shopify_pay-41f946fc7a5e408efc881b69d3e544adcaa2b7ee02b092b587318a5a1d03e001.js" crossorigin="anonymous"></script>
                ...
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb " role="list">
                        <li class="breadcrumb__item breadcrumb__item--completed">
                            <a class="breadcrumb__link" href="{{route('shop.cartIndex')}}">Giỏ Hàng</a>
                        ...
                        <li class="breadcrumb__item breadcrumb__item--current" >
                            <span class="breadcrumb__text">Thông Tin Đặt Hàng</span>
{{--                            <svg class="icon-svg icon-svg--color-adaptive-light icon-svg--size-10 breadcrumb__chevron-icon" aria-hidden="true" focusable="false"> <use xlink:href="#chevron-right" /> </svg>--}}
                        </li>
            ...
            <main class="main__content" role="main">
                <div class="step" data-step="contact_information" data-last-step="false">
                    <form method="post" action="{{ route('shop.cartStore') }}"
                          id="store-cart-contact-template-0" accept-charset="UTF-8" >
                        {{ csrf_field() }}
                                    ...
                                    <div class="fieldset">
                                        <div class="address-fields" data-address-fields>
                                            ...
                                            <div data-address-field="address2" data-autocomplete-field-container="true" class="field field--optional">
                                                <label class="field__label" for="checkout_shipping_address_address2">Ghi chú </label>
                                                <div class="field__input-wrapper">
                                                    <input name="note_order" id="note_order" placeholder="Ghi chú" autocomplete="shipping address-line2" autocorrect="off" data-backup="address2" class="field__input" size="30" type="text" />
                                                </div>
                                            </div>
                                        </div>
...
{{--                        <a aria-haspopup="dialog" data-modal="policy-refund-policy" data-title-text="Refund policy" data-close-text="Close" data-iframe="true" href="/5466033/policies/refund-policy.html?locale=en">Refund policy</a>--}}
{{--                    </li>--}}
{{--                    <li class="policy-list__item ">--}}
{{--                        <a aria-haspopup="dialog" data-modal="policy-privacy-policy" data-title-text="Privacy policy" data-close-text="Close" data-iframe="true" href="/5466033/policies/privacy-policy.html?locale=en">Privacy policy</a>--}}
{{--                    </li>--}}
{{--                    <li class="policy-list__item ">--}}
{{--                        <a aria-haspopup="dialog" data-modal="policy-terms-of-service" data-title-text="Terms of service" data-close-text="Close" data-iframe="true" href="/5466033/policies/terms-of-service.html?locale=en">Terms of service</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
            </footer>
        </div>
        <aside class="sidebar" role="complementary" style="padding-top: 1em !important;">
            ...
            <div class="sidebar__content">
                <div id="order-summary" class="order-summary order-summary--is-collapsed" data-order-summary>
                    <h2 style="font-weight: 700">Tổng đơn đặt hàng</h2>
                                                ...
                                                <td class="product__image">
                                                    <div class="product-thumbnail ">
                                                        <div class="product-thumbnail__wrapper">
                                                            <img alt="" class="product-thumbnail__image" src="{{ @$item['image'] }}" width="200" height="200"/>
                                                        </div>
                                    ...
                                    @if(!empty($buyNow) && $flagCart == 1)
                                            <tr class="product" data-product-id="6694897647804" data-variant-id="39724991643836"
                                                ...
                                                <td class="product__image">
                                                    <div class="product-thumbnail ">
                                                        <div class="product-thumbnail__wrapper">
                                                            <img alt="" class="product-thumbnail__image" src="{{@$buyNow['image']}}" width="200" height="200"/>
                                                        </div>
