...
<head>
    ...
    <title> Information - Lamnhi - Checkout</title>
    ...
    <script
        src="//cdn.shopify.com/app/services/5466033/javascripts/checkout_countries/122321436860/en/countries-9c784bd4d5aff3490e87892904bd4d06cddc0ccb-9c784bd4d5aff3490e87892904bd4d06cddc0ccb-1619810820-e1413a830127c0c2806dff1ce9313204d837ef12.js?version=edge"
        crossorigin="anonymous"></script>

    <script
        src="//cdn.shopify.com/shopifycloud/shopify/assets/checkout-866f70f541aefca055b9c1e247525379e12959562a1bbc02eba68455f51e6988.js"
        crossorigin="anonymous"></script>
    ...
    <span class="wrap">
      <span class="order-summary-toggle__inner">
        ...
        <span class="order-summary-toggle__text order-summary-toggle__text--show">
          <span>{{ __('Show ordered products') }}</span>
        ...
        <span class="order-summary-toggle__text order-summary-toggle__text--hide">
          <span>{{ __('Hide ordered products') }}</span>
            ...
            <main class="main__content" role="main">
                <div class="step" data-step="contact_information" data-last-step="false">
                    <form method="post" action="{{ route('shop.cartStore') }}"
                        ...
                        <input type="hidden" name="voucher" id="vouch" value=""/>
                                ...
                                <div class="section__content">
                                    <div class="fieldset">
                                        <div class="address-fields" data-address-fields>
                                            <div data-address-field="name" data-autocomplete-field-container="true"
                                            ...
                                            <div data-address-field="address1" data-autocomplete-field-container="true"
                                                ...
                                                <div class="field__input-wrapper">
                                                    <input name="address_order" id="address_order"
                                                           ...
                                                           data-autocomplete-trigger="true" class="field__input"
                                                           size="30" type="text"
                                            ...
                                            <div data-address-field="phone" class="field field--required">
                                                ...
                                                <div class="field__input-wrapper field__input-wrapper--icon-right">
                                                    <input name="phone_order" id="phone_order" required
                                                           ...
                                                           @if($address)value="{{ @$address->phone }}"
                                                           @endif type="tel"/>
                        ...
                        <div class="step__footer row">
                            ...
                            <a class="step__footer__previous-link" href="{{route('shop.cartIndex')}}">
                                ...
                                <table class="product-table">
                                    ...
                                    @if(!empty($arrayCart) && $flagCart == 0)
                                        @foreach($arrayCart as $item)
                                            <tr class="product" data-product-id="6694897647804"
                                                data-variant-id="39724991643836"
                                                ...
                                                <td class="product__image">
                                                    <div class="product-thumbnail ">
                                                        ...
                                                        <span class="product-thumbnail__quantity"
                                                              aria-hidden="true">{{ @$item['number'] }}</span>
                                                    </div>

                                                </td>
                                                <th class="product__description" scope="row">
                                                    <span class="product__description__name order-summary__emphasis"
                                                          style="text-align: center">{{ @$item['name'] }}</span>
                            ...
                            <table class="total-line-table">
                                ...
                                <tr class="total-line">
                                    <th class="total-line__name payment-due-label" scope="row">
                                        <span class="payment-due-label__total">{{ __('Voucher') }}</span>
                                    </th>
